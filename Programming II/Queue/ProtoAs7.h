#include "BoolAs7.h"							//include header files used in ProtoAs7

#ifndef			PROTOAS7_H						//if header not defined
#define			PROTOAS7_H						//define header

typedef struct queuenode						//Define the structure queuenode comprised of two parts:
{
	int data;									//1. The integer named data
	struct queuenode *next;						//2. The structure part of the queuenode called next
...
void add(queue*, int);							//prototype for adding to the queue
